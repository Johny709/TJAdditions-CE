...
@Deprecated
public class OldCycleButtonWidget extends CycleButtonWidget {
    ...
    public <T extends Enum<T> & IStringSerializable> OldCycleButtonWidget(int xPosition, int yPosition, int width, int height, Class<T> enumClass, Supplier<T> supplier, Consumer<T> updater, TextureArea... buttonBackground) {
     ...
     */
    public OldCycleButtonWidget setTooltipFormat(Supplier<String[]> formatSupplier) {
     ...
     */
    public OldCycleButtonWidget setToggle(boolean toggle) {
        this.toggle = toggle;
        return this;
    }
