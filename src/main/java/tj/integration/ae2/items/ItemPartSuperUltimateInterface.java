...
import static tj.integration.ae2.blocks.BlockSuperUltimateInterface.DUALITY_INSTANCE;
import static tj.integration.ae2.blocks.BlockSuperUltimateInterface.FLUID_DUALITY_INSTANCE;
...
public class ItemPartSuperUltimateInterface extends Item implements IPartItem<IPart> {
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag flagIn) {
        if (DUALITY_INSTANCE != null && FLUID_DUALITY_INSTANCE != null) {
            final DualitySuperInterface.DualityUpgradeInventory upgradeInventory = (DualitySuperInterface.DualityUpgradeInventory) BlockPatternInterface.DUALITY_INSTANCE.getInventoryByName("upgrades");
