...
import tj.integration.ae2.blocks.BlockDualInterfaceV2;
...
public class PartDualInterfaceV2 extends PartInterface implements ITileEntityUI, ISuperDualInterface {

    public static final ResourceLocation MODEL_BASE = new ResourceLocation(TJ.MODID, "part/me.part.dual_interface_v2_base");

    @PartModels
    public static final PartModel MODELS_OFF = new PartModel(MODEL_BASE, new ResourceLocation(TJ.MODID, "part/me.part.dual_interface_v2_off"));

    @PartModels
    public static final PartModel MODELS_ON = new PartModel(MODEL_BASE, new ResourceLocation(TJ.MODID, "part/me.part.dual_interface_v2_on"));

    @PartModels
    public static final PartModel MODELS_HAS_CHANNEL = new PartModel(MODEL_BASE, new ResourceLocation(TJ.MODID, "part/me.part.dual_interface_v2_has_channel"));
    ...
    public ModularUI createUI(TileEntityHolder holder, EntityPlayer player) {
        return BlockDualInterfaceV2.createDualInterfaceGUI(holder, player, this);
    }
