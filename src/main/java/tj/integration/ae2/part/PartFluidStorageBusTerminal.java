...
public class PartFluidStorageBusTerminal extends AbstractPartDisplay implements ITileEntityUI, ISuperFluidInterfaceTerminal {

    @PartModels
    public static final ResourceLocation MODEL_OFF = new ResourceLocation(TJ.MODID, "part/me.part.fluid_storage_bus_terminal_off");

    @PartModels
    public static final ResourceLocation MODEL_ON = new ResourceLocation(TJ.MODID, "part/me.part.fluid_storage_bus_terminal_on");
