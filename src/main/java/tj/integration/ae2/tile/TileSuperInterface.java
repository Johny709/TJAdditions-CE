...
public class TileSuperInterface extends TileInterface implements ITileEntityUI {
    ...
    public ModularUI createUI(TileEntityHolder holder, EntityPlayer player) {
        ...
        this.createPatternMultiToolGUI(builder.widget(new LabelWidget(7, 109, "gui.appliedenergistics2.StoredItems"))
        ...
        return builder.widget(new TJLabelWidget(7, -18, 162, 18, TJGuiTextures.MACHINE_LABEL_2)
                ...
                .widget(new TJLabelWidget(4, 0, 162, 18, null)
                        ...
                        .setCentered(false)
                        .setCanSlide(false))
                .widget(new TJToggleButtonWidget(-18, 8, 16, 16, () -> duality.getConfigManager().getSetting(Settings.BLOCK).ordinal() == 0, this::setBlockingMode)
                ...
                .widget(new TJCycleButtonWidget<>(-18, 26, 16, 16, (EnumSet<LockCraftingMode>) Settings.UNLOCK.getPossibleValues(), () -> (Enum<LockCraftingMode>) duality.getConfigManager().getSetting(Settings.UNLOCK), this::setLockCrafting)
                ...
                .widget(new TJToggleButtonWidget(-18, 44, 16, 16, () -> duality.getConfigManager().getSetting(Settings.INTERFACE_TERMINAL).ordinal() == 0, this::setInterfaceTerminal)
                        ...
                        .useToggleTexture(true))
                .widget(new TJToggleButtonWidget(-18, 62, 16, 16, () -> duality.getConfigManager().getSetting(Settings.OPERATION_MODE).ordinal() == 0, this::setFluidPacket)
                        ...
                        .setInvertTexture(true)
                        .useToggleTexture(true))
                .widget(new TJToggleButtonWidget(-18, 80, 16, 16, () -> duality.getConfigManager().getSetting(Settings.LEVEL_TYPE).ordinal() == 0, this::setSplittingItemsFluids)
                        ...
                        .useToggleTexture(true))
                .widget(new TJCycleButtonWidget<>(-18, 98, 16, 16, (EnumSet<CondenserOutput>) Settings.CONDENSER_OUTPUT.getPossibleValues(), () -> (Enum<CondenserOutput>) duality.getConfigManager().getSetting(Settings.CONDENSER_OUTPUT), this::setBlockModeEx)
                ...
                .widget(new TJToggleButtonWidget(-18, 116, 16, 16, () -> ((RCIConfigurableObject) duality).r$getConfigManager().getSetting(RCSettings.IntelligentBlocking).ordinal() == 0, this::setIntelligentBlocking)
                        ...
                        .setInvertTexture(true)
                        .useToggleTexture(true))
                .widget(new TJToggleButtonWidget(-18, 134, 16, 16, () -> false, (BooleanConsumer) bool -> this.changePatternAmount(duality.getPatterns(), 2, patternScrollableSlotGroup, () -> {}))
                ...
                .widget(new TJToggleButtonWidget(-18, 152, 16, 16, () -> false, (BooleanConsumer) bool -> this.changePatternAmount(duality.getPatterns(), -2, patternScrollableSlotGroup, () -> {}))
                ...
                .widget(new TJToggleButtonWidget(-18, 170, 16, 16, () -> false, (BooleanConsumer) bool -> this.changePatternAmount(duality.getPatterns(), 3, patternScrollableSlotGroup, () -> {}))
                ...
                .widget(new TJToggleButtonWidget(-18, 188, 16, 16, () -> false, (BooleanConsumer) bool -> this.changePatternAmount(duality.getPatterns(), -3, patternScrollableSlotGroup, () -> {}))
    ...
    private void createPatternMultiToolGUI(ModularUI.Builder builder, ItemStack patternMultiTool, FilteredItemStackHandler multiUpgradeSlots, IItemHandler patternSlots, IItemHandler multiPatternSlots, NBTTagCompound invTag) {
        if (!patternMultiTool.isEmpty()) {
            ...
            builder.widget(new ImageWidget(-125, 0, 105, 218, GuiTextures.BORDERED_BACKGROUND))
                    ...
                    .widget(new ButtonWidget<>(-118, 176, 18, 18, "*2", data -> this.changePatternAmount(multiPatternSlots, 2, multiPatternSlotGroup, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
                    ...
                    .widget(new ButtonWidget<>(-118, 194, 18, 18, "/2", data -> this.changePatternAmount(multiPatternSlots, -2, multiPatternSlotGroup, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
                    ...
                    .widget(new ButtonWidget<>(-100, 176, 18, 18, "*3", data -> this.changePatternAmount(multiPatternSlots, 3, multiPatternSlotGroup, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
                    ...
                    .widget(new ButtonWidget<>(-100, 194, 18, 18, "/3", data -> this.changePatternAmount(multiPatternSlots, -3, multiPatternSlotGroup, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
                    ...
                    .widget(new ButtonWidget<>(-82, 176, 18, 18, "*4", data -> this.changePatternAmount(multiPatternSlots, 4, multiPatternSlotGroup, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
                            .setBackgroundTextures(GuiTextures.VANILLA_BUTTON))
                    .widget(new ButtonWidget<>(-82, 194, 18, 18, "/4", data -> this.changePatternAmount(multiPatternSlots, -4, multiPatternSlotGroup, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
                            .setBackgroundTextures(GuiTextures.VANILLA_BUTTON))
                    .widget(new ButtonWidget<>(-64, 176, 36, 36, "X", data -> this.clearPatterns(multiPatternSlots, () -> this.writePatternMultiToolToNBT(multiPatternSlots, invTag)))
    ...
    private void changePatternAmount(IItemHandler patternSlots, int multiplier, SlotScrollableWidgetGroup patternSlotWidgets, Runnable callback) {
