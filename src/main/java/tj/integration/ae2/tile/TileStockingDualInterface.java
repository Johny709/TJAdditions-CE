...
public class TileStockingDualInterface extends TileInterface implements IFluidInterfaceHost, IConfigurableFluidInventory, ITileEntityUI {
    ...
    public ModularUI createUI(TileEntityHolder holder, EntityPlayer player) {
        ...
        final WidgetTabBuilder tabBuilder = new WidgetTabBuilder()
                ...
                .addTab("tile.me.stocking_interface.name", TJBlocks.STOCKING_INTERFACE.maybeStack(1).orElse(ItemStack.EMPTY), widgets -> this.createInterfaceTab(widgets, buttonPopUpWidget))
                .addTab("tile.me.stocking_fluid_interface.name", TJBlocks.STOCKING_FLUID_INTERFACE.maybeStack(1).orElse(ItemStack.EMPTY), widgets -> this.createFluidInterfaceTab(widgets, buttonPopUpWidget));
