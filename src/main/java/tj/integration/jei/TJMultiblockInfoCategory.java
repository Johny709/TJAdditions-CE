        ...
        if (multiblockRecipes == null) {
            ImmutableMap.Builder<String, MultiblockInfoRecipeWrapper> multiblockRecipes = new ImmutableMap.Builder<>();
                    ...
                    multiblockRecipes.put("mega_coke_oven", new MultiblockInfoRecipeWrapper(new MegaCokeOvenInfo()))
                            ...
                            .put("parallel_volcanus", new MultiblockInfoRecipeWrapper(new ParallelVolcanusInfo()))
                            .put("parallel_large_alloy_smelter", new MultiblockInfoRecipeWrapper(new ParallelLargeAlloySmelterInfo()))
                            ...
                            .put("mega_fusion.2", new MultiblockInfoRecipeWrapper(new MegaFusionInfo()))
                            ...
                            .put("advanced_large_chunk_miner.6", new MultiblockInfoRecipeWrapper(new AdvancedLargeChunkMinerInfo(6)))
                            .put("advanced_large_chunk_miner.7", new MultiblockInfoRecipeWrapper(new AdvancedLargeChunkMinerInfo(7)))
                            .put("advanced_large_chunk_miner.8", new MultiblockInfoRecipeWrapper(new AdvancedLargeChunkMinerInfo(8)))
                            .put("advanced_large_chunk_miner.9", new MultiblockInfoRecipeWrapper(new AdvancedLargeChunkMinerInfo(9)))
                            .put("advanced_large_chunk_miner.10", new MultiblockInfoRecipeWrapper(new AdvancedLargeChunkMinerInfo(10)))
                            .put("void_large_chunk_miner", new MultiblockInfoRecipeWrapper(new VoidAdvancedLargeChunkMinerInfo()))
