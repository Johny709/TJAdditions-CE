...
public class LargeAlloySmelterInfo extends TJMultiblockInfoPage {
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        final TJMultiblockShapeInfo.Builder builder = TJMultiblockShapeInfo.builder(BlockPattern.RelativeDirection.RIGHT, BlockPattern.RelativeDirection.UP, BlockPattern.RelativeDirection.BACK)
    ...
    public String[] getDescription() {
        return ArrayUtils.addAll(new String[]{I18n.format("tj.multiblock.large_alloy_smelter.description").replace("§7", "§r")},
