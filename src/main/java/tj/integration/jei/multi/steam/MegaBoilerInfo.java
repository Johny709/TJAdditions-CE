...
public class MegaBoilerInfo extends MultiblockInfoPage {
    ...
    protected void generateBlockTooltips() {
        ...
        final Block casing = this.boilerType.casingState.getBlock();
        final Block firebox = this.boilerType.fireboxState.getBlock();
    ...
    public String[] getDescription() {
        return new String[] {
                ...
                I18n.format("tj.multiblock.universal.tooltip.2", TJValues.thousandFormat.format(this.megaBoiler.getParallel()))};
    }
