...
import tj.machines.multi.parallel.MetaTileEntityParallelLargeAssembler;
...
public class ParallelLargeAssemblerInfo extends TJMultiblockInfoPage implements IParallelMultiblockInfoPage {
    ...
    @Override
    public MetaTileEntityParallelLargeAssembler getController() {
    ...
    public MultiblockShapeInfo getMatchingShapes(int extent) {
        ...
        return builder.aisle("I~CGGG" + aisleG, "CCCGGG" + aisleG, "CCCGGG" + aisleG, "CCCCCC" + aisleC)
                ...
                .aisle("CCCCCC" + aisleC, "CCCCCC" + aisleC, "CCCCCC" + aisleC, "CCCCCC" + aisleC).where('S', this.getController(), WEST)
