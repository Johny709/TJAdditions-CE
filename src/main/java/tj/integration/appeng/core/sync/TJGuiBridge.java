...
public enum TJGuiBridge implements IGuiHandler {
    GUI_HANDLER(),
    GUI_SUPER_INTERFACE(ContainerSuperInterface.class, IInterfaceHost.class, TJGuiHostType.WORLD, SecurityPermissions.BUILD);

    private final Class tileClass;
    private final Class containerClass;
    private Class guiClass;
    private TJGuiHostType type;
    ...
    TJGuiBridge(GuiWrapper.IExternalGui obj) {
        this.tileClass = null;
        this.containerClass = null;
    ...
    TJGuiBridge(final Class containerClass, final SecurityPermissions requiredPermission) {
    ...
    TJGuiBridge(final Class containerClass, final Class tileClass, final TJGuiHostType type, final SecurityPermissions requiredPermission) {
        this.requiredPermission = requiredPermission;
        this.containerClass = containerClass;
        this.type = type;
    ...
    public Object getServerGuiElement(final int ordinal, final EntityPlayer player, final World w, final int x, final int y, final int z) {
        ...
        final TJGuiBridge ID = values()[ordinal >> 4];
