...
public class DualCover extends CoverBehavior implements CoverWithUI, ITickable {
    ...
    private void createPumpTab(List<Widget> widgetGroup) {
        ...
        widgetGroup.add(new ButtonWidget<>(44, 20, 24, 20, "-10", data -> this.setFluidTransferRate(this.fluidTransferRate - (data.isShiftClick ? 50 : 10))).setBackgroundTextures(GuiTextures.VANILLA_BUTTON));
