...
public class TJItems {
    ...
    public static Item PART_SUPER_INTERFACE;
    ...
    public static void init(IForgeRegistry<Item> registry) {
        ...
        PART_SUPER_INTERFACE = registerItem(registry, "me.part.super_interface", new ItemPartSuperInterface());
        ...
        Api.INSTANCE.getPartModels().registerModels(TJ_ITEM_REGISTRY.values().stream()
