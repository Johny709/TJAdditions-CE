...
public abstract class MixinMetaTileEntityElectricBlastFurnace extends MixinGARecipeMapMultiblockController {
    ...
    public MixinMetaTileEntityElectricBlastFurnace(ResourceLocation metaTileEntityId) {
