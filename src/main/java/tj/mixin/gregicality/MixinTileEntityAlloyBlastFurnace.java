...
public abstract class MixinTileEntityAlloyBlastFurnace extends MixinGARecipeMapMultiblockController {
    @Shadow
    ...
    public MixinTileEntityAlloyBlastFurnace(ResourceLocation metaTileEntityId) {
