...
public abstract class MixinMultiRecipeMapMultiblockController extends MixinLargeSimpleRecipeMapMultiblockController {

    @Shadow
    protected RecipeMap<?>[] recipeMaps;

    public MixinMultiRecipeMapMultiblockController(ResourceLocation metaTileEntityId) {
