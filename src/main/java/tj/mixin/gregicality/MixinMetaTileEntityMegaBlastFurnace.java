...
public abstract class MixinMetaTileEntityMegaBlastFurnace extends MixinMegaMultiblockRecipeMapController {
    ...
    public MixinMetaTileEntityMegaBlastFurnace(ResourceLocation metaTileEntityId) {
