...
public abstract class MixinMetaTileEntityLargeMiner extends MixinGAMultiblockWithDisplayBase {
    ...
    public MixinMetaTileEntityLargeMiner(ResourceLocation metaTileEntityId) {
