...
public abstract class MixinMetaTileEntityBatteryTower extends MixinGAMultiblockWithDisplayBase implements IProgressBar {

    @Shadow
    private long passiveDrain;

    public MixinMetaTileEntityBatteryTower(ResourceLocation metaTileEntityId) {
