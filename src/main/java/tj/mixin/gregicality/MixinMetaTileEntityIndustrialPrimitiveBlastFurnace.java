...
public abstract class MixinMetaTileEntityIndustrialPrimitiveBlastFurnace extends MixinMultiblockWithDisplayBase {
    ...
    public MixinMetaTileEntityIndustrialPrimitiveBlastFurnace(ResourceLocation metaTileEntityId) {
