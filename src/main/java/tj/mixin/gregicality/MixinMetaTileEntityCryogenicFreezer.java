...
public abstract class MixinMetaTileEntityCryogenicFreezer extends MixinMetaTileEntityVacuumFreezer implements IProgressBar {
    public MixinMetaTileEntityCryogenicFreezer(ResourceLocation metaTileEntityId) {
