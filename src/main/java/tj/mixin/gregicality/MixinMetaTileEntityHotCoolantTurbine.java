...
public abstract class MixinMetaTileEntityHotCoolantTurbine extends MixinHotCoolantMultiblockController implements IProgressBar {
    ...
    public MixinMetaTileEntityHotCoolantTurbine(ResourceLocation metaTileEntityId) {
