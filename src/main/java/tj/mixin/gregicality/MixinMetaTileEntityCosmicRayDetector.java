...
public abstract class MixinMetaTileEntityCosmicRayDetector extends MixinMultiblockWithDisplayBase {
    @Shadow
    ...
    public MixinMetaTileEntityCosmicRayDetector(ResourceLocation metaTileEntityId) {
