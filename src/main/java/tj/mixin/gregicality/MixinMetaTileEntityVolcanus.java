...
public abstract class MixinMetaTileEntityVolcanus extends MixinMetaTileEntityElectricBlastFurnace implements IProgressBar {
    public MixinMetaTileEntityVolcanus(ResourceLocation metaTileEntityId) {
