...
public abstract class MixinRecipeMapSteamMultiblockController extends MixinMultiblockWithDisplayBase {
    ...
    public MixinRecipeMapSteamMultiblockController(ResourceLocation metaTileEntityId) {
