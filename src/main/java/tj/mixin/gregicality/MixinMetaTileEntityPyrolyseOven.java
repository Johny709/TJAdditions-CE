...
public abstract class MixinMetaTileEntityPyrolyseOven extends MixinGARecipeMapMultiblockController {
    ...
    public MixinMetaTileEntityPyrolyseOven(ResourceLocation metaTileEntityId) {
