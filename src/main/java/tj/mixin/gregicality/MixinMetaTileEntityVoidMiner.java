...
public abstract class MixinMetaTileEntityVoidMiner extends MixinGAMultiblockWithDisplayBase implements IProgressBar {
    ...
    public MixinMetaTileEntityVoidMiner(ResourceLocation metaTileEntityId) {
