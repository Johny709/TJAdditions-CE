...
public abstract class MixinLargeSimpleRecipeMapMultiblockController extends MixinGARecipeMapMultiblockController {

    @Shadow
    public long maxVoltage;

    public MixinLargeSimpleRecipeMapMultiblockController(ResourceLocation metaTileEntityId) {
