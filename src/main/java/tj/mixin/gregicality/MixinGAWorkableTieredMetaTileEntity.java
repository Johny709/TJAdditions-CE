...
public abstract class MixinGAWorkableTieredMetaTileEntity extends MixinGATieredMetaTileEntity implements IProcessorProvider {
    ...
    public MixinGAWorkableTieredMetaTileEntity(ResourceLocation metaTileEntityId) {
