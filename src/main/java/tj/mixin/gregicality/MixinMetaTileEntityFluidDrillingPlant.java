...
public abstract class MixinMetaTileEntityFluidDrillingPlant extends MixinMultiblockWithDisplayBase implements IProgressBar {
    ...
    public MixinMetaTileEntityFluidDrillingPlant(ResourceLocation metaTileEntityId) {
