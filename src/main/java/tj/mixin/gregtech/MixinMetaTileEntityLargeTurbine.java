...
public abstract class MixinMetaTileEntityLargeTurbine extends MixinRotorHolderMultiblockController implements IProgressBar {

    @Shadow
    @Final
    private static int MIN_DURABILITY_TO_WARN;

    public MixinMetaTileEntityLargeTurbine(ResourceLocation metaTileEntityId) {
