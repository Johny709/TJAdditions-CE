...
public abstract class MixinWorkableTieredMetaTileEntity extends MixinTieredMetaTileEntity implements IProcessorProvider {
    ...
    public MixinWorkableTieredMetaTileEntity(ResourceLocation metaTileEntityId) {
