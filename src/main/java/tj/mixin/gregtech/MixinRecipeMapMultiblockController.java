...
public abstract class MixinRecipeMapMultiblockController extends MixinMultiblockWithDisplayBase {
    ...
    public MixinRecipeMapMultiblockController(ResourceLocation metaTileEntityId) {
