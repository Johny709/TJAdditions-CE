...
public abstract class MixinRotorHolderMultiblockController extends MixinFueledMultiblockController {
    ...
    public MixinRotorHolderMultiblockController(ResourceLocation metaTileEntityId) {
