...
public abstract class TJMultiRecipeMapMultiblockControllerBase extends MultiRecipeMapMultiblockController implements IMultiblockAbilityPart<IItemHandlerModifiable> {
    ...
    protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
        ...
        builder.widget(new TJLabelWidget(-1, -38, 184, 20, TJGuiTextures.MACHINE_LABEL, () -> Gregicality.MODID + ":" + this.getRecipeMaps()[this.getRecipeMapIndex()].getUnlocalizedName())
