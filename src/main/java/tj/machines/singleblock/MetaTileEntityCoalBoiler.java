...
public class MetaTileEntityCoalBoiler extends MetaTileEntity implements IWorkable, IFuelInfo, IFuelable, IHeatInfo {
    ...
    protected ModularUI createUI(EntityPlayer player) {
        ...
        return ModularUI.builder(boilerType.getBackground(), 176, 167)
                .widget(new TJLabelWidget(7, -18, 162, 18, this.boilerType == BRONZE ? TJGuiTextures.MACHINE_LABEL_BRONZE : this.boilerType == STEEL ? TJGuiTextures.MACHINE_LABEL_STEEL : TJGuiTextures.MACHINE_LABEL)
