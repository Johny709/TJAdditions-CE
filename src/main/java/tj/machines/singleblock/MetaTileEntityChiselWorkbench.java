...
public class MetaTileEntityChiselWorkbench extends TJTieredWorkableMetaTileEntity {
    ...
    protected ModularUI createUI(EntityPlayer player) {
        ...
        return builder.image(-28, 0, 26, 104, BORDERED_BACKGROUND)
                ...
                .widget(new TJToggleButtonWidget(25, 62, 18, 18, BUTTON_FLUID_OUTPUT, this::isAutoOutputFluids, this::setFluidAutoOutput)
                        .setToggleTitleTooltipHoverText("gregtech.gui.fluid_auto_output.tooltip.disabled", "grgetech.gui.fluid_auto_output.toolitp.enabled"))
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        TJTextures.TJ_ASSEMBLER_OVERLAY.render(renderState, translation, pipeline, this.frontFacing, this.workableHandler.isActive(), this.workableHandler.isHasProblems(), this.workableHandler.isWorkingEnabled());
