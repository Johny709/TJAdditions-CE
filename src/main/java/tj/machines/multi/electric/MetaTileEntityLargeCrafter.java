...
public class MetaTileEntityLargeCrafter extends TJMultiblockControllerBase implements IRecipeMapProvider {
    ...
    protected void addDisplayText(GUIDisplayBuilder builder) {
        ...
        if (this.isStructureFormed())
            builder.addVoltageInLine(this.inputEnergyContainer)
                    ...
                    .addIsWorkingLine(this.recipeLogic.isWorkingEnabled(), this.recipeLogic.isActive(), this.recipeLogic.getProgress(), this.recipeLogic.getMaxProgress(), this.recipeLogic.isHasProblems())
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        TJTextures.TJ_MULTIBLOCK_WORKABLE_OVERLAY.render(renderState, translation, pipeline, this.getFrontFacing(), this.recipeLogic.isActive(), this.recipeLogic.isHasProblems(), this.recipeLogic.isWorkingEnabled());
