                ...
                builder.addTextComponent(new TextComponentString(": [§a" + (++searchResults[0]) + "§r] ")
                        ...
                        .setStyle(new Style()
                                .setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(name)
                                        ...
                                        .appendText("\n")
                                        .appendSibling(new TextComponentTranslation("tj.machine.universal.linked.dimension", dimensionName, TJValues.thousandFormat.format(dimensionID)))
                                        .appendText("\n")
                                        .appendSibling(new TextComponentTranslation("tj.machine.universal.linked.pos", TJValues.thousandFormat.format(x), TJValues.thousandFormat.format(y), TJValues.thousandFormat.format(z))))))
                        .appendText("\n")
