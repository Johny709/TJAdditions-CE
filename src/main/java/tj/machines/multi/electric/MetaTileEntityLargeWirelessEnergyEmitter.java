                ...
                builder.addTextComponent(new TextComponentString(": [§a" + (++searchResults[0]) + "§r] ")
                        .appendSibling(new TextComponentString(name)).setStyle(new Style()
                                .setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(name)
                                        .appendText("\n")
                                        .appendSibling(new TextComponentTranslation("machine.universal.energy.stored", TJValues.thousandFormat.format(isMetaTileEntity ? EUStored : RFStored), TJValues.thousandFormat.format(isMetaTileEntity ? EUCapacity : RFCapacity)))
                                        .appendText("\n")
                                        .appendSibling(new TextComponentTranslation("tj.machine.universal.linked.dimension", world != null ? world.provider.getDimensionType().getName() : "N/A", TJValues.thousandFormat.format(world != null ? world.provider.getDimension() : 0)))
                                        .appendText("\n")
                        ...
                        .appendText("\n")
                        .appendSibling(new TextComponentTranslation("machine.universal.energy.amps", TJValues.thousandFormat.format(this.workableHandler.getEntityEnergyAmps()[i]))
                                .appendText(" ")
