                ...
                builder.addTextComponent(new TextComponentString(": [§a" + (++searchResults[0]) + "§r] ")
                        .appendSibling(new TextComponentString(name)).setStyle(new Style()
                                .setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(name)
                                        ...
                                        .appendText("\n")
                                        .appendSibling(new TextComponentTranslation("machine.universal.linked.dimension", world != null ? world.provider.getDimensionType().getName() : "N/A", TJValues.thousandFormat.format(world != null ? world.provider.getDimension() : 0)))
                                        .appendText("\n")
