...
public class TJGAFuelRecipeLogic extends AbstractGAFuelRecipeLogic<TJGAFuelRecipeLogic> implements IGeneratorInfo, IFuelable, IItemFluidHandlerInfo {
    ...
    public TJGAFuelRecipeLogic(MetaTileEntity metaTileEntity, HotCoolantRecipeMap recipeMap, Supplier<IEnergyContainer> energyContainer, Supplier<IMultipleTankHandler> fluidTank, long maxVoltage) {
    ...
    public Collection<IFuelInfo> getFuels() {
        ...
        for (IFluidTank fluidTank : fluidTanks) {
            ...
            HotCoolantRecipe recipe = this.recipeMap.findRecipe(this.maxVoltageSupplier.getAsLong(), tankContents);
